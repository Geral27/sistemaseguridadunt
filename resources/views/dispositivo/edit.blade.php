<div class="modal fade" tabindex="-1" role="dialog" id="editdis{{$dis->iddispositivo}}" >
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            {!! Form::model($dispositivo, [ 'method' => 'patch','route' => ['dispositivo.update', $dis->iddispositivo] ]) !!}
                @csrf
            <div class="row">
                    {!! Form::number('iddispositivo', $dis->iddispositivo, ['class' => 'form-control', 'hidden']) !!}
...
<!-- Delete Modal -->
<div class="modal fade" id="destroydis{{$dis->iddispositivo}}" tabindex="-1" role="dialog" data-backdrop="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
              {!! Form::model($dispositivo, [ 'method' => 'delete','route' => ['dispositivo.destroy', $dis->iddispositivo] ]) !!}
