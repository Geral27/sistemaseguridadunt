<div class="modal fade" tabindex="-1" role="dialog" id="creardis" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['url' => 'dispositivo/store', 'method' => 'get']) !!}
                @csrf
                <div class="row">
                    ...
                    <div class="form-group col-4">
                        ...
                        {!! Form::select('tipodispositivo', array('' => 'Seleccione un tipo','Laptop' => 'Laptop', 'Tablet' => 'Tablet', 'Mouse' => 'Mouse'),'', ['class' => 'form-control']) !!}
                    </div>
                    <div class="form-group col-4">
                        {!! Form::label('color', 'Color') !!}
                        {!! Form::text('color', '', ['class' => 'form-control', 'required']) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-3">
                        {!! Form::label('marca', 'Marca') !!}
                        {!! Form::text('marca', '', ['class' => 'form-control', 'required']) !!}
                    </div>
                    <div class="form-group col-4">
                        {!! Form::label('serie', 'Serie') !!}
                        {!! Form::text('serie', '', ['class' => 'form-control', 'required']) !!}
                    </div>
