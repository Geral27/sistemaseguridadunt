                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <form action="{{route('dispositivo.store')}}" method="GET" novalidate id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <select id="facultad" class="form-control" required name="tipodispositivo">
                                    ...
                                    <div class="field item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" name="marca" required="required" type="text" data-validate-length-range="100" id="txtmarca" />
                                        </div>
                                    </div>
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Color</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" type="text" name="color" data-validate-length-range="100" required='required' id="txtcolor"/>
                                        </div>
                                    </div>
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Serie</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" type="text" name="serie" data-validate-length-range="100" required='required' id="txtserie"/>
                                        </div>
                                    </div>
                                    <div class="item form-group">
