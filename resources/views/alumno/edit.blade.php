                            ...
                            <div class="x_content">
                                ...
                                <form action="{{route('alumno.update', $alumno->idalumno)}}" method="GET" novalidate id="editform">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" name="nombres" data-validate-length-range="100" type="text" required="required" id="txtnombres" value="{{$alumno->nombres}}"/>
                                        </div>
                                    </div>
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Apellidos</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" name="apellidos" required="required" type="text" data-validate-length-range="100" id="txtapellidos" value="{{$alumno->apellidos}}"/>
                                        </div>
                                    </div>
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Código de Matrícula</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" type="text" name="codigomatricula" data-validate-length-range="100" required='required' id="txtcodigo" value="{{$alumno->codigomatricula}}"/>
                                        </div>
                                    </div>
                                    <div class="field item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <select id="facultad" class="form-control" required name="facultad">
                                                <option value="{{$alumno->facultad}}">{{$alumno->facultad}}</option>
                                    ...
                                    <div class="field item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <select id="escuela" class="form-control" required name="escuela">
                                                <option value="{{$alumno->escuela}}">{{$alumno->escuela}}</option>
                                    ...
                                    <div class="field item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" type="tel" class='tel' name="telefono" required='required' data-validate-length-range="8,20" id="txttelefono" value="{{$alumno->telefono}}"/>
                                        </div>
                                    </div>
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Correo</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" type="email" class='email' name="correo" data-validate-linked='email' required='required' id="txtcorreo" value="{{$alumno->correo}}"/>
                                        </div>
                                    </div>
